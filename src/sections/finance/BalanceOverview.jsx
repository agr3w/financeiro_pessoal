  ...
  return (
    ...
    >
      <Box textAlign="center" mb={3}>
        <Typography variant="body2" sx={{ opacity: 0.7, letterSpacing: 1, textTransform: 'uppercase' }}>
          Saldo Total
        </Typography>
      ...
      <Grid container spacing={2}>
        <Grid item xs={6}>
          ...
          >
            <Box display="flex" alignItems="center" gap={1} mb={0.5}>
              <Box p={0.5} bgcolor="rgba(16, 185, 129, 0.2)" borderRadius="50%" display="flex">
                <TrendingUp sx={{ color: '#34d399', fontSize: 16 }} />
              </Box>
              <Typography variant="caption" sx={{ opacity: 0.8 }}>Entradas</Typography>
            </Box>
            <Typography variant="h6" fontWeight="bold" sx={{ color: '#34d399' }}>
              {displayValue(income)}
            </Typography>
          </Box>
        </Grid>
        ...
        <Grid item xs={6}>
          ...
          >
            <Box display="flex" alignItems="center" gap={1} mb={0.5}>
              <Box p={0.5} bgcolor="rgba(239, 68, 68, 0.2)" borderRadius="50%" display="flex">
                <TrendingDown sx={{ color: '#f87171', fontSize: 16 }} />
              </Box>
              <Typography variant="caption" sx={{ opacity: 0.8 }}>Saídas</Typography>
            </Box>
