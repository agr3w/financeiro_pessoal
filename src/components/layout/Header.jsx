    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          alignItems: "center",
          gap: 1.5,
          minWidth: isDesktop ? 200 : "auto", // Espaço reservado no desktop
          "&:hover": { opacity: 0.7 },
          transition: "opacity 0.2s",
        }}
      >
        {/* Ícone da Logo com Fundo Sutil */}
        <Box
          sx={{
        ...
        >
          <Code fontSize={isMobile ? "small" : "medium"} />
        </Box>
        ...
        <Box>
          <Typography
            ...
            sx={{
              ...
              WebkitTextFillColor: "transparent", // Efeito gradiente no texto
            }}
          >
            Financeiro
          </Typography>
