...
export default function AdminPanel() {
  const { isAdmin } = useAuth(); // <--- Pegando isAdmin do contexto
  const {
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} md={4}>
            ...
            >
              <Box>
                <Typography
                  variant="overline"
                  color={maintenanceMode ? "error" : "text.secondary"}
                  fontWeight="bold"
                >
            ...
            <Paper sx={{ p: 4, borderRadius: 3, height: "100%" }}>
              <Box mb={3}>
                ...
                <Typography variant="body2" color="text.secondary">
                  Envie notificações para todos os usuários do sistema. Use com
                  sabedoria.
                </Typography>
              </Box>
                ...
                <Grid item xs={12}>
                  ...
                  >
                    ...
                    <MenuItem value="update">
                      <Box display="flex" alignItems="center" gap={1}>
                        <NewReleases fontSize="small" color="secondary" />{" "}
                        Atualização / Feature
                      </Box>
                    </MenuItem>
                    <MenuItem value="warning">
                      <Box display="flex" alignItems="center" gap={1}>
                        <Warning fontSize="small" color="warning" /> Alerta
                        Importante
                      </Box>
                    </MenuItem>
                  </TextField>
          ...
          <Grid item xs={12} md={5}>
            ...
            >
              ...
              >
                <Typography variant="h6" fontFamily="serif">
                  Mural Ativo ({notifications.length})
                </Typography>
              ...
              <List sx={{ flexGrow: 1, overflowY: "auto", maxHeight: 600 }}>
                {notifications.map((note) => (
                  ...
                  >
                    <Box mr={2} mt={0.5} alignSelf="flex-start">
                      {getIcon(note.type)}
                    </Box>
                    <ListItemText
